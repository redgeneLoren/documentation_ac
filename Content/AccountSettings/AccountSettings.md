...
<table width="750px" align="center">
    <tr>
        ...
        <br />
        <hr />
        <p><b>II. Projects</b> - It contains the list of projects the user is currently assigned to and the project's last update record.</p>
...
<table border="0">
    ...
    <tr>
       <td width="300px">
        ...
        <td>
            <img src="images/ClickCheckbox.jpg" height="250px">
        </td>
    </tr>
</table>
...
<p align="center">
    <img src="images/ProfileAvatarSection.jpg" height="300px">
</p>
...
<table border="1">
    ...
    <tr>
        <td width="250px">
            <img src="images/RolesDropdown.jpg" width="300px">
        </td>
        <td>
...
<table>
    ...
    <tr>
        <td colspan="2"><img src="images/UserManagementPage.jpg" height="300px"></td>
    </tr>
</table>
...
<table>
    <tr>
        ...
        <td>
            <p>  5. In the `Profile Settings Page` scroll down to locate the `Roles` section.</p>
            <p>6. Click on the textbox with the label `Select Role`.</p>
            <hr />
        </td>
    </tr>
    <tr>
